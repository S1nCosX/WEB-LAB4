package server.database.domains.src.main.java.server.database.services;

import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Service;
import server.database.domains.src.main.java.server.database.domains.Point;
import server.database.domains.src.main.java.server.database.repositories.PointRepository;
